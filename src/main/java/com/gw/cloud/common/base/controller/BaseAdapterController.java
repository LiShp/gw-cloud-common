...
import com.gw.cloud.common.base.web.QueryResultDto;
...
*/
@LogInfo
public abstract class BaseAdapterController<ID extends Serializable, T extends BaseEntity<ID>, R extends Serializable> {
